...
//                    console.log('succes');
    ...
    function validate() {
        ...
        var alamat_korban = $('input[name=alamat_korban]').val();
        ...
        //alamat_korban
        if (alamat_korban.length < 5) {
            $('span[validationatr=alamat_korban]').html('alamat korban wajib di isi');
            succes = false;
        }
        ...
        if (no_telp_korban.length > 0) {
            if (no_telp_korban.length < 10) {
                $('span[validationatr=no_telp_korban]').html('no telp korban format salah');
                succes = false;
            }
        }
...
window.onload = function () {
    ...
    var myElement = document.getElementById('container-form');
